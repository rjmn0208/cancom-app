                  ...
                  <TableRow key={vital.id}>
                    ...
                    <TableCell>
                      <div className="flex space-x-2">
                        ...
                        <Button variant="outline" size="icon" onClick={() => handleVitalsDelete(vital)}>
              ...
              <TableBody>
                {vitalReadings.map((reading: VitalReading) => (
                    <TableRow key={reading.id}>
                      ...
                      <TableCell>{reading.Patient.User.firstName} {reading.Patient.User.middleName} {reading.Patient.User.lastName}</TableCell>
                      ...
                      <TableCell>
                        <div>{reading.RecordedBy.firstName} {reading.RecordedBy.middleName} {reading.RecordedBy.lastName}</div>
                        <Badge>{reading.RecordedBy.userType}</Badge>
                      </TableCell>
                      <TableCell>
                        <div>{reading.LastEditedBy.firstName} {reading.LastEditedBy.middleName} {reading.LastEditedBy.lastName}</div>
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          ...
                          <Button variant="outline" size="icon" onClick={() => handleVitalReadingsDelete(reading)}>
                            <Trash2 className="h-4 w-4" />
                          </Button>
                        </div>
                        </TableCell>
