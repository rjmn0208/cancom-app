...
const ListMemberForm: React.FC<ListMembershipFormProps> = ({listMember, taskListId}) => {
  ...
  const form = useForm<FormSchemaType>({
    ...
    ? {
      ...
      startDate: (listMember.startDate) ? new Date(listMember.startDate): null,
                ...
                <SelectContent>
                  {users?.map((user: User) => (
                    <SelectItem key={user.id} value={user.id}>
                      ...
                      <p><b>User Name:</b> {user.firstName} {user.middleName} {user.lastName}</p>
                      <b>{user.userType}</b>
                    </SelectItem>
                  ))}
                </SelectContent>
