...
const ExerciseTaskForm: React.FC<ExerciseTaskFormProps> = ({exerciseTask, taskListId}) => {
  ...
  const onSubmit = async (values: FormSchemaType) => {
    ...
    if(exerciseTask) {
      ...
      const {data: ExerciseTaskData, error: ExerciseTaskError} = await supabase
      .from('ExerciseTask')
      .update({
        name: values.name,
        sets: values.sets,
      ...
      if(!ExerciseTaskError) toast.success('Exercise details editted successfully')
        ...
        if(!ExerciseTaskError) toast.success('Exercise details saved successfully')
